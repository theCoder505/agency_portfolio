            ...
            <div className="min-h-screen transition-colors duration-300 pb-20">
                ...
                <header className="relative pt-8 pb-12 overflow-hidden">
                    <div className="relative max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 space-y-6">
                        ...
                        >
                            ...
                            <Link href="/blogs" className="hover:text-cyan-600 dark:hover:text-cyan-400 transition-colors">
                                Blogs
                            </Link>
                            <ChevronRight className="h-3.5 w-3.5" />
                        ...
                        <div
                            data-aos="fade-up"
                            data-aos-delay="200"
                            className="pt-4 border-t border-slate-200/60 dark:border-cyan-500/10 flex flex-col sm:flex-row sm:items-center justify-between gap-4"
                        >
                            <div className="flex items-center space-x-3.5">
                                {blog.author_avatar ? (
                                    ...
                                    <div className="h-12 w-12 rounded-full bg-cyan-500 text-slate-950 font-bold flex items-center justify-center text-base shadow-md">
                            ...
                            <div className="flex items-center space-x-2">
                                ...
                                <button
                                    ...
                                    className="p-2 rounded-xl cv-card text-slate-600 dark:text-slate-300 hover:text-cyan-600 dark:hover:text-cyan-400 transition-colors"
                ...
                <article className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 pt-8 space-y-10">
                    ...
                    {blog.thumbnail && (
                        <div
                            data-aos="zoom-in"
                            className="relative rounded-3xl overflow-hidden shadow-2xl border border-slate-200/60 dark:border-cyan-500/20 bg-slate-950 aspect-[16/9]"
                        >
                            <img
                                src={blog.thumbnail}
                                alt={blog.title}
                    ...
                    <div
                        data-aos="fade-up"
                        className="cv-card rounded-3xl p-6 sm:p-12 shadow-sm"
                    >
                        <div
                        ...
                        {blog.tags && blog.tags.length > 0 && (
                            <div className="mt-12 pt-6 border-t border-slate-100 dark:border-cyan-500/10 flex flex-wrap items-center gap-2">
                                ...
                                {blog.tags.map((tag, tIdx) => (
                                    <Link
                                        ...
                                        className="px-3 py-1 rounded-lg text-xs font-semibold bg-slate-100 dark:bg-[#01121e] text-slate-700 dark:text-slate-300 border border-slate-200/60 dark:border-cyan-500/15 hover:border-cyan-500/50 hover:text-cyan-600 dark:hover:text-cyan-400 transition-colors"
                                    >
                                        #{tag}
                                    </Link>
                                ))}
                    ...
                    <div
                        data-aos="fade-up"
                        className="cv-card p-8 rounded-3xl shadow-sm flex flex-col sm:flex-row items-center justify-between gap-6"
                    >
                        <div className="flex items-center space-x-4">
                            {blog.author_avatar ? (
                                <img
                                    src={blog.author_avatar}
                                    alt={blog.author_name || 'Author'}
                                    className="h-16 w-16 rounded-2xl object-cover border border-cyan-500/30"
                                />
                            ) : (
                                <div className="h-16 w-16 rounded-2xl bg-cyan-500 text-slate-950 font-bold flex items-center justify-center text-xl shadow">
                                    {blog.author_name ? blog.author_name.charAt(0) : 'C'}
                                </div>
                            )}
                            <div>
                                <p className="text-xs font-bold uppercase tracking-wider text-cyan-600 dark:text-cyan-400">Written by</p>
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                                {relatedBlogs.map((rel, idx) => (
                                    <Link
                                        ...
                                        className="cv-card group rounded-2xl p-4 shadow-sm hover:shadow-lg transition-all flex flex-col justify-between space-y-4"
                                    >
                                        ...
                                        <div className="space-y-1.5 flex-grow">
                                            ...
                                            <h3 className="text-sm font-bold text-slate-900 dark:text-white line-clamp-2 group-hover:text-cyan-600 dark:group-hover:text-cyan-400 transition-colors leading-snug">
                                                {rel.title}
                                            </h3>
                                        </div>

                                        <div className="pt-2 border-t border-slate-100 dark:border-cyan-500/10 flex items-center justify-between text-xs text-slate-500 dark:text-slate-400">
                    ...
                    <div
                        data-aos="zoom-in"
                        className="cv-card rounded-3xl p-8 sm:p-10 text-white shadow-xl text-center space-y-4 border-cyan-500/30"
                    >

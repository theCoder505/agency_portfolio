...
<head>
    ...
    <title>403 - Access Forbidden | CodeVenture Tech</title>
...
<body class="min-h-screen flex flex-col justify-between relative overflow-x-hidden selection:bg-orange-500 selection:text-slate-950">

    <!-- Ambient glowing backdrop -->
    <div class="fixed inset-0 pointer-events-none overflow-hidden z-0">
        <div class="absolute -top-32 left-1/2 -translate-x-1/2 w-[650px] h-[550px] rounded-full blur-[140px] bg-orange-500/20 animate-cv-pulse"></div>
        <div class="absolute -bottom-32 right-1/4 w-[550px] h-[450px] rounded-full blur-[140px] bg-red-600/20"></div>
    ...
    <header class="relative z-20 w-full px-6 py-4 border-b border-slate-800/80 bg-slate-950/70 backdrop-blur-xl">
        <div class="max-w-7xl mx-auto flex items-center justify-between">
            <a href="/" class="flex items-center gap-3">
                <div class="w-9 h-9 rounded-xl bg-gradient-to-tr from-orange-500 to-red-600 flex items-center justify-center text-white font-black text-base shadow-lg shadow-orange-500/20">
                    CV
                </div>
    ...
    <main class="relative z-10 flex-grow flex flex-col items-center justify-center px-4 py-16 text-center">
        <div class="w-full max-w-3xl mx-auto flex flex-col items-center">
            ...
            <div class="relative select-none my-2">
                <span class="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 text-[140px] sm:text-[220px] font-black tracking-tighter text-orange-500/15 blur-md">
                    403
                </span>
                <h1 class="text-[90px] sm:text-[160px] font-black tracking-tight leading-none bg-gradient-to-r from-orange-400 via-amber-400 to-red-500 bg-clip-text text-transparent">
                    403
                </h1>
            </div>
            ...
            <p class="text-slate-400 text-sm sm:text-base leading-relaxed max-w-lg mx-auto mb-8">
                You do not have clearance or sufficient privileges to access this area. Please verify your credentials or sign in.
            </p>
            ...
            <div class="w-full max-w-xl bg-slate-900/60 border border-slate-800/80 rounded-3xl p-6 sm:p-8 backdrop-blur-xl shadow-2xl">
                <div class="flex flex-wrap items-center justify-center gap-3.5">
                    <a href="/login" class="inline-flex items-center gap-2 px-6 py-3 rounded-xl bg-gradient-to-r from-orange-500 to-red-600 hover:from-orange-400 hover:to-red-500 text-white font-bold text-sm shadow-lg shadow-orange-500/25 transition-all">

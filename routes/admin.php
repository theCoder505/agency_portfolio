...
Route::prefix('admin')->name('admin.')->group(function () {
    ...
    Route::middleware('auth:admin')->group(function () {
        ...
        Route::get('custom-orders/{ref}/{title?}', [CustomOrderController::class, 'show'])->name('custom-orders.show');
        Route::put('custom-orders/{ref}', [CustomOrderController::class, 'update'])->name('custom-orders.update');
        ...
        Route::post('custom-orders/{ref}/budget-requests/approve', [CustomOrderController::class, 'approveBudgetRequest'])->name('custom-orders.budget-requests.approve');
        Route::post('custom-orders/{ref}/budget-requests/decline', [CustomOrderController::class, 'declineBudgetRequest'])->name('custom-orders.budget-requests.decline');
        Route::get('custom-orders/{ref}/report/{title?}', [CustomOrderController::class, 'showReport'])->name('custom-orders.report');
        Route::post('custom-orders/{ref}/reviews/{reviewId}/toggle-featured', [CustomOrderController::class, 'toggleReviewFeatured'])->name('custom-orders.reviews.toggle-featured');
        Route::delete('custom-orders/{ref}', [CustomOrderController::class, 'destroy'])->name('custom-orders.destroy');

        // Milestone management inside custom order
        Route::post('custom-orders/{ref}/milestones', [CustomOrderMilestoneController::class, 'store'])->name('custom-orders.milestones.store');
        Route::put('custom-orders/{ref}/milestones/{milestoneId}', [CustomOrderMilestoneController::class, 'update'])->name('custom-orders.milestones.update');
        Route::post('custom-orders/{ref}/milestones/{milestoneId}/status', [CustomOrderMilestoneController::class, 'updateStatus'])->name('custom-orders.milestones.status');
        Route::post('custom-orders/{ref}/milestones/{milestoneId}/refund', [CustomOrderController::class, 'refundMilestone'])->name('custom-orders.milestones.refund');
        Route::delete('custom-orders/{ref}/milestones/{milestoneId}', [CustomOrderMilestoneController::class, 'destroy'])->name('custom-orders.milestones.destroy');
